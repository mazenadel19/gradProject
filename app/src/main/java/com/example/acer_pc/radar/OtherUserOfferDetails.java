...
public class OtherUserOfferDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_user_offer_details);
    ...
    public void goToChat(View view) {
        Intent intent = new Intent(this, Chat.class); //intent(from here,to.....)
    ...
    public void Alert (View view){
        AlertDialog.Builder builder = new  AlertDialog.Builder(OtherUserOfferDetails.this);
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(OtherUserOfferDetails.this, "Your offer was sent", Toast.LENGTH_SHORT).show();
            }
        })
    ...
    public void reportFun(View view) {
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(OtherUserOfferDetails.this, "Thank you", Toast.LENGTH_SHORT).show();
            }
        })
                .setNegativeButton("cancel", new DialogInterface.OnClickListener() {
                    @Override
